...
export type GOGFixture = {
  ...
  /**
   * ประกาศเวลาเตะแล้วหรือยัง
   * พรีเมียร์ลีกประกาศวันก่อน แล้วค่อยเคาะเวลาตามการถ่ายทอดสดทีหลัง
   * ระหว่างนั้น football-data.org ส่ง 00:00 UTC มาเป็นค่าแทน ไม่ใช่เวลาเตะจริง
   * ถ้าไม่แยกไว้ หน้าเว็บจะโชว์ "เวลาไทย 07:00 น." เหมือนเป็นเวลาจริง
   * และแผนวันแข่งที่คิดถอยหลังจากเวลาเตะจะผิดทั้งวัน
   */
